...
task_prompt = (
    ...
    f"{action_emoji} *Как действовать?*\n[Здесь призыв к действию. Предложи как можно поделиться результатами или мыслями в комментариях (например, наблюдениями, фото, инсайтами, словами, впечатлениями). Сделай это приглашающим и мотивирующим, но не настаивай. Все только по желанию. Не более 1-2 предложений.]\n\n"
    "ВАЖНО:\n"
